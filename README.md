...
Unia-Danmuku 用于连接 B 站直播间，接收实时弹幕、礼物、醒目留言和舰长事件，并将内容展示到控制台或 OBS 浏览器源中。项目还提供后台多房间监控、按场次历史记录与实时直播分析、认证中心、答谢页、OBS 时钟、字体与素材管理等直播辅助能力。
...
- 多房间后台监控
- 按房间和场次保存历史记录
- 直播场次指标分析：大航海、粉丝团/粉丝、高能榜、看过人数与时长曲线
- 舰长数据管理与统计
- 礼物答谢展示和素材上传
- OBS 时钟显示与配置
- 字体上传和本地静态资源托管
